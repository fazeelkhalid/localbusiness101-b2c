...
class UserBusinessProfileMapper
{
    ...
    public static function mapUserBusinessProfileRequestToUserBusinessProfileResponse($userBusinessProfileRequest, $acquirer, $businessProfile, $category)
    {
        return [
            ...
            'business_profile_url'=>env('FRONTEND_URL').'/'.$userBusinessProfileRequest["business_profile"]['slug'],
    ...
    public static function mapUserBusinessProfileToUpdateUserBusinessProfileResponse($userBusinessProfileRequest)
    {
        return [
            ...
            'business_profile_url'=>env('FRONTEND_URL').'/'.$userBusinessProfileRequest->slug,
    ...
    public static function mapUserBusinessProfileToGetUserBusinessProfileResponse($userBusinessProfileRequest)
    {
        return [
            ...
            'avg_rating' => number_format($userBusinessProfileRequest->ratings->avg("rating"), 1) ?? 0,
        ];
    }
